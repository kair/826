...
After finding the anomalous rows, human need to manually interpret and further digging the root causes. In \cite{Xu}, they further applied their algorithms into some of Google’s production logs. Since the data is large which makes it unrealistic to perform PCA, they used frequent mining techniques to segment the long-lasting sequence into sessions.
